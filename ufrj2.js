...
const accounts =
    ...
    const drexToken = new ethers.Contract('0xD50765c82F54bbc505c0179E373b9bD1870eC2F5', abiDrexToken, drex);

     /// Merkle Contract
     const parsedMerkle = JSON.parse(fs.readFileSync("./artifacts/MerkleContract.json"));
     const abiMerkle = parsedMerkle.abi;
     const merkleContract = new ethers.Contract('0x6166e4296cfDb9c9dCb7910c7e437EddE1FdD808', abiMerkle, drex);

    /// Listrack Contract
    const parsedListrack = JSON.parse(fs.readFileSync("./artifacts/DrexListrack.json"));
    const abiDrexListrack = parsedListrack.abi;
    const Listrack = new ethers.Contract('0x72153754c50983Cc02F1a0a08E58c5Ff5c7258ae', abiDrexListrack, drex);
    ...
    const alienListrack = new ethers.Contract('0xAbaEC3525c5f5daaC209E8d22b5061F7b48BE0E7', abiAlienListrack, alien);
