...
const accounts =
    ...
    const drexToken = new ethers.Contract('0x4a5377f417341c4AF079c7458475490A315A5738', abiDrexToken, drex);

     /// Merkle Contract
     const parsedMerkle = JSON.parse(fs.readFileSync("./artifacts/MerkleContract.json"));
     const abiMerkle = parsedMerkle.abi;
     const merkleContract = new ethers.Contract('0xfD7d17bA040C6D45aC77A4BAEF9F5Ce04626BE57', abiMerkle, drex);

    /// Listrack Contract
    const parsedListrack = JSON.parse(fs.readFileSync("./artifacts/DrexListrack.json"));
    const abiDrexListrack = parsedListrack.abi;
    const Listrack = new ethers.Contract('0x36dc499d07fc7C103b9C140E2C32740CC900d5f6', abiDrexListrack, drex);

     /// Alien Token
     const parsed= JSON.parse(fs.readFileSync("./artifacts/AlienToken.json"));
     const abi = parsed.abi;
     const alienToken = new ethers.Contract('0x6B2669c0CeD21817FEE720e937F2f230f966c4B0', abi, alien);
       
    /// Alien Listrack Contract
    const parsedAlienListrack = JSON.parse(fs.readFileSync("./artifacts/AlienListrack.json"));
    const abiAlienListrack = parsedAlienListrack.abi;
    const alienListrack = new ethers.Contract('0xC8B701Dcf01289E380e3f41bf58E6545175F1a71', abiAlienListrack, alien);
    ...
    const mikeAlienBalance =  await (alienToken.balanceOf(mikeAlien.address));
      ...
      // Approving AlienListrack to spend Drex Tokens
