...
const accounts =
    ...
    const drexToken = new ethers.Contract('0x036d32f2851f89f27755B222FC88d1021789B8A3', abiDrexToken, drex);

     /// Merkle Contract
     const parsedMerkle = JSON.parse(fs.readFileSync("./artifacts/MerkleContract.json"));
     const abiMerkle = parsedMerkle.abi;
     const merkleContract = new ethers.Contract('0x119faCEc45639e53ae89C59d7893e470880dC281', abiMerkle, drex);

    /// Listrack Contract
    const parsedListrack = JSON.parse(fs.readFileSync("./artifacts/DrexListrack.json"));
    const abiDrexListrack = parsedListrack.abi;
    const Listrack = new ethers.Contract('0x61e7957d1607fd0C7D7760D8ac9c5D46b9bD4212', abiDrexListrack, drex);

     /// Alien Token
     const parsed= JSON.parse(fs.readFileSync("./artifacts/AlienToken.json"));
     const abi = parsed.abi;
     const alienToken = new ethers.Contract('0xE6bF68aC94E36054111B12d1E38b76e3cb5a7DbF', abi, alien);
    ...
    const alienListrack = new ethers.Contract('0x208b1044FaA961085514869261405064370c00f2', abiAlienListrack, alien);
